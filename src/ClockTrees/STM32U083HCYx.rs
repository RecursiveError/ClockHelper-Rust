...
pub struct ClockTree {
    ...
    pub LPUART3Mult: LPUART3MultConf,
...
impl ClockTree {
    ...
    fn LPTIM3Mult_get(&self) -> Result<f32, ClockError> {
        match self.LPTIM3Mult {
            LPTIM3MultConf::APBPrescaler => return self.APBPrescaler_get(),
    ...
    fn LPUART3Mult_get(&self) -> Result<f32, ClockError> {
        match self.LPUART3Mult {
            LPUART3MultConf::APBPrescaler => return self.APBPrescaler_get(),
            LPUART3MultConf::SysCLKOutput => return self.SysCLKOutput_get(),
            LPUART3MultConf::HSIRC => return self.HSIRC_get(),
            LPUART3MultConf::LSEOSC => return self.LSEOSC_get(),
        };
    }
    pub fn LPUART3output_get(&self) -> Result<f32, ClockError> {
        self.LPUART3Mult_get()
    }
    ...
    fn USBMult_get(&self) -> Result<f32, ClockError> {
        match self.USBMult {
            USBMultConf::MSIRC => return self.MSIRC_get(),
            USBMultConf::HSI48RC => return self.HSI48RC_get(),

...
impl ClockTree {
    ...
    pub fn I2S2ClkOutput_get(&self) -> Result<f32, ClockError> {
        self.SysCLKOutput_get()
    }
    pub fn I2S3ClkOutput_get(&self) -> Result<f32, ClockError> {
        self.SysCLKOutput_get()
    }
    ...
    fn HCLKDiv2_get(&self) -> Result<f32, ClockError> {
        let input = self.AHBOutput_get()? as f32;
        let value = 2 as f32;
        Ok((input / value) as f32)
    }

    pub fn SDIOHCLKDiv2_get(&self) -> Result<f32, ClockError> {
        self.HCLKDiv2_get()
    }
    ...
    pub fn SDIOClkOutput_get(&self) -> Result<f32, ClockError> {
        self.AHBOutput_get()
    }

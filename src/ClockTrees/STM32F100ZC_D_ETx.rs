...
impl HSEDivPLLConf {
    pub fn get(&self) -> Result<f32, ClockError> {
        match self {
            ...
            HSEDivPLLConf::DIV3 => return Ok(3.0),
            HSEDivPLLConf::DIV4 => return Ok(4.0),
            HSEDivPLLConf::DIV5 => return Ok(5.0),
            HSEDivPLLConf::DIV6 => return Ok(6.0),
            HSEDivPLLConf::DIV7 => return Ok(7.0),
            HSEDivPLLConf::DIV8 => return Ok(8.0),
            HSEDivPLLConf::DIV9 => return Ok(9.0),
            HSEDivPLLConf::DIV10 => return Ok(10.0),
            HSEDivPLLConf::DIV11 => return Ok(11.0),
            HSEDivPLLConf::DIV12 => return Ok(12.0),
            HSEDivPLLConf::DIV13 => return Ok(13.0),
            HSEDivPLLConf::DIV14 => return Ok(14.0),
            HSEDivPLLConf::DIV15 => return Ok(15.0),
            HSEDivPLLConf::DIV16 => return Ok(16.0),
        }
    }
}
#[derive(Debug, Clone, PartialEq, Eq)]
...
impl ClockTree {
    ...
    pub fn FSMClkOutput_get(&self) -> Result<f32, ClockError> {
        self.AHBOutput_get()
    }

...
impl PLLDSIODFConf {
    pub fn get(&self) -> Result<f32, ClockError> {
        match self {
            ...
            PLLDSIODFConf::DIV3 => return Ok(3.0),
            PLLDSIODFConf::DIV4 => return Ok(4.0),
            PLLDSIODFConf::DIV5 => return Ok(5.0),
            PLLDSIODFConf::DIV6 => return Ok(6.0),
            PLLDSIODFConf::DIV7 => return Ok(7.0),
            PLLDSIODFConf::DIV8 => return Ok(8.0),
            PLLDSIODFConf::DIV9 => return Ok(9.0),
        }
    }
}
#[derive(Debug, Clone)]
...
impl ClockTree {
    ...
    pub fn SHSIRC_get(&self) -> Result<f32, ClockError> {
        Ok(48000000 as f32)
    }
    fn SHSIDiv_get(&self) -> Result<f32, ClockError> {
        let input = self.SHSIRC_get()? as f32;
        let value = 2 as f32;
    ...
    fn SAESMult_get(&self) -> Result<f32, ClockError> {
        match self.SAESMult {
            SAESMultConf::SHSIRC => return self.SHSIRC_get(),
            SAESMultConf::SHSIDiv => return self.SHSIDiv_get(),
        };
    }
    ...
    fn HSPIMult_get(&self) -> Result<f32, ClockError> {
        match self.HSPIMult {
            HSPIMultConf::SysCLKOutput => return self.SysCLKOutput_get(),
            HSPIMultConf::PLL1Q => return self.PLL1Q_get(),
            HSPIMultConf::PLL2Q => return self.PLL2Q_get(),
            HSPIMultConf::PLL3R => return self.PLL3R_get(),
        };
    }
    pub fn HSPIoutput_get(&self) -> Result<f32, ClockError> {
        self.HSPIMult_get()
    }
    fn LTDCMult_get(&self) -> Result<f32, ClockError> {
        match self.LTDCMult {
            LTDCMultConf::PLL2R => return self.PLL2R_get(),
            LTDCMultConf::PLL3R => return self.PLL3R_get(),
        };
    }
    ...
    fn I2C5Mult_get(&self) -> Result<f32, ClockError> {
        match self.I2C5Mult {
            I2C5MultConf::APB1Prescaler => return self.APB1Prescaler_get(),
            I2C5MultConf::SysCLKOutput => return self.SysCLKOutput_get(),
            I2C5MultConf::HSIRC => return self.HSIRC_get(),
            I2C5MultConf::MSIKRC => return self.MSIKRC_get(),
        };
    }
    pub fn I2C5output_get(&self) -> Result<f32, ClockError> {
        self.I2C5Mult_get()
    }
    fn I2C6Mult_get(&self) -> Result<f32, ClockError> {
        match self.I2C6Mult {
            I2C6MultConf::APB1Prescaler => return self.APB1Prescaler_get(),
            I2C6MultConf::SysCLKOutput => return self.SysCLKOutput_get(),
            I2C6MultConf::HSIRC => return self.HSIRC_get(),
            I2C6MultConf::MSIKRC => return self.MSIKRC_get(),
        };
    }
    pub fn I2C6output_get(&self) -> Result<f32, ClockError> {
        self.I2C6Mult_get()
    }
    ...
    fn SAI2Mult_get(&self) -> Result<f32, ClockError> {
        match self.SAI2Mult {
            ...
            SAI2MultConf::PLL1P => return self.PLL1P_get(),
            SAI2MultConf::SAI1_EXT => return self.SAI1_EXT_get(),
    ...
    fn PLL1PDiv2_get(&self) -> Result<f32, ClockError> {
        let input = self.PLL1P_get()? as f32;
        let value = 2 as f32;
        Ok((input / value) as f32)
    }

    fn USBPHYMult_get(&self) -> Result<f32, ClockError> {
        match self.USBPHYMult {
            USBPHYMultConf::HSEOSC => return self.HSEOSC_get(),
            USBPHYMultConf::HSEDiv2 => return self.HSEDiv2_get(),
            USBPHYMultConf::PLL1P => return self.PLL1P_get(),
            USBPHYMultConf::PLL1PDiv2 => return self.PLL1PDiv2_get(),
        };
    }
    pub fn USBPHYoutput_get(&self) -> Result<f32, ClockError> {
        self.USBPHYMult_get()
    }
    ...
    fn DSIMult_get(&self) -> Result<f32, ClockError> {
        match self.DSIMult {
            DSIMultConf::PLL3P => return self.PLL3P_get(),
    ...
    fn DSITXPrescaler_get(&self) -> Result<f32, ClockError> {
        let input = self.DSIoutput_get()? as f32;
    ...
    pub fn PLLDSIoutput_get(&self) -> Result<f32, ClockError> {
        ...
        } else if input < (32250000 as f32) {
            return Err(ClockError {
                err_type: ClockErrorType::Underflow(input as u32, 32250000),
                from: ClockNodes::PLLDSIODF,
                to: ClockNodes::PLLDSIoutput,
            });
        }

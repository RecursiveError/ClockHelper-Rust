...
impl ClockTree {
    ...
    pub fn HSIUSB48_get(&self) -> Result<f32, ClockError> {
        Ok(48000000 as f32)
    }
    ...
    fn SysClkSource_get(&self) -> Result<f32, ClockError> {
        match self.SysClkSource {
            ...
            SysClkSourceConf::HSIUSB48 => return self.HSIUSB48_get(),
    ...
    fn USBMult_get(&self) -> Result<f32, ClockError> {
        match self.USBMult {
            USBMultConf::HSIUSB48 => return self.HSIUSB48_get(),
    ...
    fn MCOMult_get(&self) -> Result<f32, ClockError> {
        match self.MCOMult {
            ...
            MCOMultConf::HSIUSB48 => return self.HSIUSB48_get(),
        };
    }
    ...
    fn MCO2Mult_get(&self) -> Result<f32, ClockError> {
        match self.MCO2Mult {
            ...
            MCO2MultConf::HSIUSB48 => return self.HSIUSB48_get(),
        };
    }

...
impl AHB2PrescalerConf {
    pub fn get(&self) -> Result<f32, ClockError> {
        match self {
            ...
            AHB2PrescalerConf::DIV3 => return Ok(3.0),
            AHB2PrescalerConf::DIV4 => return Ok(4.0),
            AHB2PrescalerConf::DIV5 => return Ok(5.0),
            AHB2PrescalerConf::DIV6 => return Ok(6.0),
            AHB2PrescalerConf::DIV8 => return Ok(8.0),
            AHB2PrescalerConf::DIV10 => return Ok(10.0),
            AHB2PrescalerConf::DIV16 => return Ok(16.0),
            AHB2PrescalerConf::DIV32 => return Ok(32.0),

...
#[derive(Debug, Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serialize", derive(serde::Serialize))]
pub enum TIMMUX2Conf {
    TIMMUL,
    TimPrescOut1,
}
#[derive(Debug, Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serialize", derive(serde::Serialize))]
pub enum TIMMUX3Conf {
    TIMMUL,
    TimPrescOut1,
}
#[derive(Debug, Clone, PartialEq, Eq)]
...
pub struct ClockTree {
    ...
    pub TIMMUX2: TIMMUX2Conf,
    pub TIMMUX3: TIMMUX3Conf,
...
impl ClockTree {
    ...
    fn TIMMUX2_get(&self) -> Result<f32, ClockError> {
        match self.TIMMUX2 {
            TIMMUX2Conf::TIMMUL => return self.TIMMUL_get(),
            TIMMUX2Conf::TimPrescOut1 => return self.TimPrescOut1_get(),
        };
    }
    pub fn TIM2out_get(&self) -> Result<f32, ClockError> {
        self.TIMMUX2_get()
    }
    fn TIMMUX3_get(&self) -> Result<f32, ClockError> {
        match self.TIMMUX3 {
            TIMMUX3Conf::TIMMUL => return self.TIMMUL_get(),
            TIMMUX3Conf::TimPrescOut1 => return self.TimPrescOut1_get(),
        };
    }
    pub fn TIM3out_get(&self) -> Result<f32, ClockError> {
        self.TIMMUX3_get()
    }
    ...
    fn TIMMUX20_get(&self) -> Result<f32, ClockError> {
        match self.TIMMUX20 {
            TIMMUX20Conf::TIMMUL => return self.TIMMUL_get(),
            TIMMUX20Conf::TimPrescOut2 => return self.TimPrescOut2_get(),
        };
    }
    pub fn TIM20out_get(&self) -> Result<f32, ClockError> {
        self.TIMMUX20_get()
    }

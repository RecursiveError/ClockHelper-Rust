...
impl ClockTree {
    ...
    pub fn SysCLKOutput_get(&self) -> Result<f32, ClockError> {
        ...
        if input > (480000000 as f32) {
            return Err(ClockError {
                err_type: ClockErrorType::Overflow(input as u32, 480000000),
    ...
    fn DSIMult_get(&self) -> Result<f32, ClockError> {
        match self.DSIMult {
            DSIMultConf::DIVQ2 => return self.DIVQ2_get(),
    ...
    pub fn DSIoutput_get(&self) -> Result<f32, ClockError> {
        ...
        if input > (62000000 as f32) {
            return Err(ClockError {
                err_type: ClockErrorType::Overflow(input as u32, 62000000),
    ...
    pub fn AHBOutput_get(&self) -> Result<f32, ClockError> {
        ...
        if input > (240000000 as f32) {
            return Err(ClockError {
                err_type: ClockErrorType::Overflow(input as u32, 240000000),
    ...
    fn SAI23Mult_get(&self) -> Result<f32, ClockError> {
        match self.SAI23Mult {
            SAI23MultConf::DIVQ1 => return self.DIVQ1_get(),
            SAI23MultConf::DIVP2 => return self.DIVP2_get(),
            SAI23MultConf::DIVP3 => return self.DIVP3_get(),
            SAI23MultConf::I2S_CKIN => return self.I2S_CKIN_get(),
            SAI23MultConf::CKPERSource => return self.CKPERSource_get(),
        };
    }
    pub fn SAI23output_get(&self) -> Result<f32, ClockError> {
        let input = self.SAI23Mult_get()?;
        if input > (150000000 as f32) {
            return Err(ClockError {
                err_type: ClockErrorType::Overflow(input as u32, 150000000),
                from: ClockNodes::SAI23Mult,
                to: ClockNodes::SAI23output,
            });
        } else if input < (0 as f32) {
            return Err(ClockError {
                err_type: ClockErrorType::Underflow(input as u32, 0),
    ...
    fn I2C123Mult_get(&self) -> Result<f32, ClockError> {
        match self.I2C123Mult {
            I2C123MultConf::D2PPRE1 => return self.D2PPRE1_get(),
    ...
    pub fn I2C123output_get(&self) -> Result<f32, ClockError> {
        let input = self.I2C123Mult_get()?;
        if input > (125000000 as f32) {
            return Err(ClockError {
                err_type: ClockErrorType::Overflow(input as u32, 125000000),
                from: ClockNodes::I2C123Mult,
                to: ClockNodes::I2C123output,
            });
        } else if input < (0 as f32) {
            return Err(ClockError {
                err_type: ClockErrorType::Underflow(input as u32, 0),
    ...
    pub fn USBoutput_get(&self) -> Result<f32, ClockError> {
        ...
        if input > (66000000 as f32) {
            return Err(ClockError {
                err_type: ClockErrorType::Overflow(input as u32, 66000000),
    ...
    pub fn HRTIMoutput_get(&self) -> Result<f32, ClockError> {
        let input = self.HrtimMult_get()?;
        if input > (480000000 as f32) {
            return Err(ClockError {
                err_type: ClockErrorType::Overflow(input as u32, 480000000),
                from: ClockNodes::HrtimMult,
                to: ClockNodes::HRTIMoutput,
            });
        } else if input < (0 as f32) {
            return Err(ClockError {
                err_type: ClockErrorType::Underflow(input as u32, 0),

...
impl ClockTree {
    ...
    fn FDCAN1Mult_get(&self) -> Result<f32, ClockError> {
        match self.FDCAN1Mult {
            FDCAN1MultConf::APBPrescaler => return self.APBPrescaler_get(),
            FDCAN1MultConf::HSIKER => return self.HSIKER_get(),
            FDCAN1MultConf::HSEOSC => return self.HSEOSC_get(),
        };
    }
    pub fn FDCAN1output_get(&self) -> Result<f32, ClockError> {
        self.FDCAN1Mult_get()
    }

...
impl ClockTree {
    ...
    fn LVDSMult_get(&self) -> Result<f32, ClockError> {
        match self.LVDSMult {
            LVDSMultConf::XBAR32Output => return self.XBAR32Output_get(),
            LVDSMultConf::HSEOSC => return self.HSEOSC_get(),
        };
    }
    pub fn LVDSoutput_get(&self) -> Result<f32, ClockError> {
        self.LVDSMult_get()
    }

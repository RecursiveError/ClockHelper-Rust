...
impl ClockTree {
    ...
    fn I2S2Mult_get(&self) -> Result<f32, ClockError> {
        match self.I2S2Mult {
            ...
            I2S2MultConf::PLLP => return self.PLLP_get(),
    ...
    fn USART3Mult_get(&self) -> Result<f32, ClockError> {
        match self.USART3Mult {
            USART3MultConf::APBPrescaler => return self.APBPrescaler_get(),
    ...
    fn HSICECCDevisor_get(&self) -> Result<f32, ClockError> {
        let input = self.HSIRC_get()? as f32;
    ...
    fn CECMult_get(&self) -> Result<f32, ClockError> {
        match self.CECMult {
            CECMultConf::HSICECCDevisor => return self.HSICECCDevisor_get(),
    ...
    fn RNGHSIDiv_get(&self) -> Result<f32, ClockError> {
        let input = self.HSIRC_get()? as f32;
        let value = 8 as f32;
        Ok((input / value) as f32)
    }
    ...
    fn CK48Mult_get(&self) -> Result<f32, ClockError> {
        match self.CK48Mult {
            ...
            CK48MultConf::RNGHSIDiv => return self.RNGHSIDiv_get(),
        };
    }
    ...
    fn I2C2Mult_get(&self) -> Result<f32, ClockError> {
        match self.I2C2Mult {
            I2C2MultConf::APBPrescaler => return self.APBPrescaler_get(),
    ...
    fn FDCANMult_get(&self) -> Result<f32, ClockError> {
        match self.FDCANMult {
            FDCANMultConf::APBPrescaler => return self.APBPrescaler_get(),
    ...
    fn USBMult_get(&self) -> Result<f32, ClockError> {
        match self.USBMult {
            ...
            USBMultConf::HSEOSC => return self.HSEOSC_get(),
        };
    }
    ...
    fn MCO2Mult_get(&self) -> Result<f32, ClockError> {
        match self.MCO2Mult {
            ...
            MCO2MultConf::PLLQ => return self.PLLQ_get(),
